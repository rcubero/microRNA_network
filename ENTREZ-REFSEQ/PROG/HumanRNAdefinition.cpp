// This program reads in the definition for Human
// RNAs from human.rna.gbff file.
// -------------------------------------------
...
int main(int argc, char *argv[])
{
	...
	// Open input file
	ifstream IN("DATA/human.rna.gbff");
	if(!IN.is_open()) { cout << "Error: Input File" << endl; exit(1); }	

	// Open output file
	ofstream OUT("DATA/Human_refseqtid_Definition.txt");
